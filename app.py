...
data = pd.read_csv("C:/Users/saroj/Documents/GitHub/Heroku_dash_cholera/choleraDeaths.tsv",sep='\t')
...
fig.show()
import pandas as pd
data = pd.read_csv("C:/Users/saroj/Documents/GitHub/Heroku_dash_cholera/naplesCholeraAgeSexData.tsv",sep='\t')
#print(data)
fig = go.Figure(data=[go.Table(
    header=dict(values=list(data.columns),
                fill_color='paleturquoise',
...
fig.show()
data = pd.read_csv("C:/Users/saroj/Documents/GitHub/Heroku_dash_cholera/UKcensus1851.csv",sep=",",skiprows=[0,1,2])
...
fig.show()
data = pd.read_csv("C:/Users/saroj/Documents/GitHub/Heroku_dash_cholera/Copy of choleraDeathLocations.csv",sep=",",header=None)
data.columns=["Death","long","lat"]
dataa = pd.read_csv("C:/Users/saroj/Documents/GitHub/Heroku_dash_cholera/choleraPumpLocations.csv",sep=",",header=None)
